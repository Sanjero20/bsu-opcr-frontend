...
let routeAddr = import.meta.env.MODE == 'development' ? 'http://localhost:5050' : window.location.origin;
...
export const declineOpcr = async (detailedOpcrArray) => {
    ...
    arrayParamChecker(['targetID', 'successIDs'], detailedOpcrArray.targets, 'targets');
